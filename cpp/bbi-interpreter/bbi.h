...
#define SHORT_P(p) (short int *)(p)		// short int 형의 포인터로 변환
#define UCHAR_P(p) (unsigned char *)(p)	// unsigned char 형의 포인터로 변환
